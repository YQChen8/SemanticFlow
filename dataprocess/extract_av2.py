...
def main(
    argo_dir: str = "/home3/hqlab/chenyq/nas/av2",
    output_dir: str ="/dataset/public_dataset_nas2/av2/preprocess_v2",
    av2_type: str = "sensor",
    data_mode: str = "val",
    mask_dir: str = "/home3/hqlab/chenyq/nas/av2/3d_scene_flow",
