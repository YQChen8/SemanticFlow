...
class ModelWrapper(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.cfg_loss_name in ['seflowLoss']:
            ...
            loss_logger = {'chamfer_dis': 0.0, 'dynamic_chamfer_dis': 0.0, 'static_flow_loss': 0.0, 'cluster_based_pc0pc1': 0.0, 'rigid_loss': 0.0, 'smooth_loss': 0.0, 'mask_loss': 0.0}
        else:
        ...
        for batch_id in range(batch_sizes):
            ...
            if 'pc0_dynamic' in batch:
                ...
                print(dict2loss['pc0_labels'].shape)
