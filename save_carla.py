...
@hydra.main(version_base=None, config_path="conf", config_name="save_carla")
def main(cfg):
    ...
    use_fg_inds = True
    test_dataset = CARLA3D(root_dir=cfg.dataset_path + 'val/', nb_points=16384, mode="test",
